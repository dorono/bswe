<div class="homepage-signup">
    ...
    <div id="mc_embed_signup">
        <form action="https://bestsaxophonewebsiteever.us2.list-manage.com/subscribe/post?u=42c62e22f20fe87b4c27dc640&amp;id=e0aed5ed01" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
            <div class="mc-field-group">
                ...
                <input type="text" value="" title="Email Address" name="EMAIL" class="required email" id="mce-EMAIL">
            </div>
            <div class="mc-field-group">
                <!--<label for="mce-FNAME">First Name </label>
                <input type="text" title="First Name" value="" name="FNAME" class="" id="mce-FNAME">-->
                <input type="submit" value="Sign me up! &raquo;" name="subscribe" id="mc-embedded-subscribe" class="btn">
            </div>
    ...
    <script type="text/javascript">
        ...
        mce_jQuery(document).ready( function($) {
            ...
            options = { url: 'http://bestsaxophonewebsiteever.us2.list-manage.com/subscribe/post-json?u=42c62e22f20fe87b4c27dc640&id=e0aed5ed01&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
