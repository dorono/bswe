...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_footer_slider_acc' => $themify_customizer->accordion_start( __( 'Footer Slider', 'themify' ) ),

		'footer_sliderwrap_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Slider Wrap Background', 'themify' ),
			),
		...
		'footer_sliderwrap_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Slider Wrap Border', 'themify' ),
				'show_label' => false,
		...
		'footer_sliderwrap_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Slider Wrap Padding', 'themify' ),
				'show_label' => false,
		...
		'footer_sliderwrap_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Slider Wrap Margin', 'themify' ),
				'show_label' => false,
		...
		'end_footer_slider_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
