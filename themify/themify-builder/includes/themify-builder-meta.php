						...
						<div class="themify_module_holder">
							...
							<div class="themify_builder_module module-<?php echo $mod['mod_name']; ?> active_module" data-mod-name="<?php echo esc_attr( $mod['mod_name'] ); ?>">
								...
								<div class="themify_module_settings">
									<?php $mod_settings = json_encode( $mod['mod_settings'] ); ?>
							...
							<?php elseif( isset( $mod['cols'] ) && count( $mod['cols'] ) > 0 ):
								...
								<div data-gutter="<?php echo $sub_row_gutter; ?>" class="themify_builder_sub_row clearfix">
									...
									<div class="themify_builder_sub_row_content">
										...
										<div class="themify_builder_col <?php echo $sub_col['grid_class']; ?>">
											<div class="themify_module_holder">
												<div class="empty_holder_text"><?php _e('drop module here', 'themify') ?></div><!-- /empty module text -->
												<?php if ( isset( $sub_col['modules'] ) && count( $sub_col['modules'] ) > 0 ):
													foreach( $sub_col['modules'] as $sub_module ): ?>
													<div class="themify_builder_module module-<?php echo $sub_module['mod_name']; ?> active_module" data-mod-name="<?php echo esc_attr( $sub_module['mod_name'] ); ?>">
														<div class="module_menu">
															<div class="menu_icon">
															</div>
															<ul class="themify_builder_dropdown">
														...
														<div class="module_label">
															...
															<em class="module_excerpt"><?php echo $this->get_module_excerpt( $sub_module ); ?></em>
														</div>
														<div class="themify_module_settings">
															<?php $sub_mod_settings = json_encode( $sub_module['mod_settings'] ); ?>
															<script type="text/json"><?php echo $sub_mod_settings; ?></script>
														</div>
													</div>
													<!-- /active_module -->
