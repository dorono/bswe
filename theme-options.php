...
class Themify {
	...
	static $sidebar1_content_width = 642;
	static $sidebar2_content_width = 474;
	
	// Default Single Post Layout
	static $single_content_width = 978;
	static $single_sidebar1_content_width = 642;
	static $single_sidebar2_content_width = 474;
	...
	// List Large
	static $list_large_image_width = 716;
	...
	function template_redirect() {
		...
		if( is_single() ) {
			...
			self::$sidebar2_content_width = self::$single_sidebar2_content_width;
